...
extension PipelineMiddlewareReactiveSwiftTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__PipelineMiddlewareReactiveSwiftTests = [
...
extension PublisherTypeBridgeTests {
    ...
    static let __allTests__PublisherTypeBridgeTests = [
        ("testPublisherTypeToSignalProducerOnError", testPublisherTypeToSignalProducerOnError),
        ("testPublisherTypeToSignalProducerOnValue", testPublisherTypeToSignalProducerOnValue),
        ("testSignalProducerToPublisherTypeOnError", testSignalProducerToPublisherTypeOnError),
        ("testSignalProducerToPublisherTypeOnValue", testSignalProducerToPublisherTypeOnValue),
        ("testSignalToPublisherTypeOnError", testSignalToPublisherTypeOnError),
        ("testSignalToPublisherTypeOnValue", testSignalToPublisherTypeOnValue),
    ]
}
...
extension ReplayLastSubjectTypeBridgeTests {
    ...
    static let __allTests__ReplayLastSubjectTypeBridgeTests = [
        ...
        ("testMutablePropertyToReplayLastSubjectTypeOnValue", testMutablePropertyToReplayLastSubjectTypeOnValue),
    ]
}
...
extension SubjectTypeBridgeTests {
    ...
    static let __allTests__SubjectTypeBridgeTests = [
        ...
        ("testSignalToSubjectTypeOnError", testSignalToSubjectTypeOnError),
        ("testSignalToSubjectTypeOnValue", testSignalToSubjectTypeOnValue),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        testCase(PipelineMiddlewareReactiveSwiftTests.__allTests__PipelineMiddlewareReactiveSwiftTests),
