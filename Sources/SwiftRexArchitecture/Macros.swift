...
// Re-export both FPMacros and SwiftRexSwiftUI so a single `import SwiftRexArchitecture`
// is sufficient — no explicit imports of @Prisms, @Lenses, @ViewModel, or @BoundTo needed.
